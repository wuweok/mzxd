...
.method private a([B)Ljava/lang/String;
    ...
    invoke-static {p1, v5}, Lcn/sharesdk/wechat/utils/WechatHelper;->a([B[B)Z

    move-result v5

    if-nez v5, :cond_0

    invoke-static {p1, v6}, Lcn/sharesdk/wechat/utils/WechatHelper;->a([B[B)Z
    ...
    :cond_1
    invoke-static {p1, v2}, Lcn/sharesdk/wechat/utils/WechatHelper;->a([B[B)Z
    ...
    :cond_2
    invoke-static {p1, v1}, Lcn/sharesdk/wechat/utils/WechatHelper;->a([B[B)Z
    ...
    :cond_3
    invoke-static {p1, v0}, Lcn/sharesdk/wechat/utils/WechatHelper;->a([B[B)Z
    ...
    :cond_4
    invoke-static {p1, v3}, Lcn/sharesdk/wechat/utils/WechatHelper;->a([B[B)Z

    move-result v0

    if-nez v0, :cond_5

    invoke-static {p1, v4}, Lcn/sharesdk/wechat/utils/WechatHelper;->a([B[B)Z
...
.method private a(Landroid/content/Context;[B)[B
    ...
    invoke-direct {p0, p2}, Lcn/sharesdk/wechat/utils/WechatHelper;->a([B)Ljava/lang/String;
    ...
    invoke-static {p2, v4, v2, v1}, Landroid/graphics/BitmapFactory;->decodeByteArray([BIILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v1, v2, v2}, Lcn/sharesdk/wechat/utils/WechatHelper;->a(Landroid/graphics/BitmapFactory$Options;II)I
...
.method private b(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-direct {p0, v1}, Lcn/sharesdk/wechat/utils/WechatHelper;->a([B)Ljava/lang/String;
    :try_end_0
...
.method private b(Landroid/content/Context;Ljava/lang/String;)[B
    ...
    invoke-static {v2, v1, v1}, Lcn/sharesdk/wechat/utils/WechatHelper;->a(Landroid/graphics/BitmapFactory$Options;II)I
    ...
    :cond_5
    invoke-direct {p0, p2}, Lcn/sharesdk/wechat/utils/WechatHelper;->b(Ljava/lang/String;)Ljava/lang/String;
