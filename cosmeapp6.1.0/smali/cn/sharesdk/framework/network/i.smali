...
.method private a(Ljava/lang/String;Ljava/util/ArrayList;Lcn/sharesdk/framework/network/f;)Lorg/apache/http/client/methods/HttpPost;
    .locals 8
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    new-instance v3, Lcn/sharesdk/framework/network/g;

    invoke-direct {v3}, Lcn/sharesdk/framework/network/g;-><init>()V
    ...
    invoke-virtual {v4, v6}, Lcn/sharesdk/framework/network/n;->a(Ljava/lang/String;)Lcn/sharesdk/framework/network/n;
    ...
    invoke-virtual {v0, v2}, Lcn/sharesdk/framework/network/n;->a(Ljava/lang/String;)Lcn/sharesdk/framework/network/n;

    move-result-object v0

    const-string v5, "\r\n"

    invoke-virtual {v0, v5}, Lcn/sharesdk/framework/network/n;->a(Ljava/lang/String;)Lcn/sharesdk/framework/network/n;
    ...
    iget-object v6, p3, Lcn/sharesdk/framework/network/f;->a:Ljava/lang/String;
    ...
    invoke-virtual {v4, v5}, Lcn/sharesdk/framework/network/n;->a(Ljava/lang/String;)Lcn/sharesdk/framework/network/n;

    move-result-object v5

    invoke-virtual {v5, v0}, Lcn/sharesdk/framework/network/n;->a(Ljava/lang/String;)Lcn/sharesdk/framework/network/n;
    ...
    invoke-virtual {v3, v4}, Lcn/sharesdk/framework/network/g;->a(Lcn/sharesdk/framework/network/e;)Lcn/sharesdk/framework/network/g;
    ...
    invoke-virtual {v0, v4}, Lcn/sharesdk/framework/network/n;->a(Ljava/lang/String;)Lcn/sharesdk/framework/network/n;

    move-result-object v4

    invoke-virtual {v4, v2}, Lcn/sharesdk/framework/network/n;->a(Ljava/lang/String;)Lcn/sharesdk/framework/network/n;

    move-result-object v2

    const-string v4, "--\r\n"

    invoke-virtual {v2, v4}, Lcn/sharesdk/framework/network/n;->a(Ljava/lang/String;)Lcn/sharesdk/framework/network/n;

    invoke-virtual {v3, v0}, Lcn/sharesdk/framework/network/g;->a(Lcn/sharesdk/framework/network/e;)Lcn/sharesdk/framework/network/g;

    invoke-virtual {v3}, Lcn/sharesdk/framework/network/g;->c()Lorg/apache/http/entity/InputStreamEntity;
...
.method public a(Ljava/lang/String;Ljava/util/ArrayList;Lcn/sharesdk/framework/network/f;Ljava/util/ArrayList;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-virtual/range {v0 .. v6}, Lcn/sharesdk/framework/network/i;->a(Ljava/lang/String;Ljava/util/ArrayList;Lcn/sharesdk/framework/network/f;Ljava/util/ArrayList;Ljava/util/ArrayList;Lcn/sharesdk/framework/network/HttpResponseCallback;)V
...
.method public a(Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    sget v4, Lcn/sharesdk/framework/network/i;->a:I
    ...
    sget v4, Lcn/sharesdk/framework/network/i;->b:I
...
.method public a(Ljava/lang/String;Ljava/util/ArrayList;Lcn/sharesdk/framework/network/f;Ljava/util/ArrayList;Ljava/util/ArrayList;Lcn/sharesdk/framework/network/HttpResponseCallback;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p1, p2, p3}, Lcn/sharesdk/framework/network/i;->a(Ljava/lang/String;Ljava/util/ArrayList;Lcn/sharesdk/framework/network/f;)Lorg/apache/http/client/methods/HttpPost;
...
.method public b(Ljava/lang/String;Ljava/util/ArrayList;Ljava/util/ArrayList;Ljava/util/ArrayList;)Ljava/lang/String;
    ...
    invoke-virtual {v3, v0}, Lorg/apache/http/client/methods/HttpPost;->setParams(Lorg/apache/http/params/HttpParams;)V
