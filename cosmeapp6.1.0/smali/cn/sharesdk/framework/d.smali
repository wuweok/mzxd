...
.method private b(Lcn/sharesdk/framework/Platform;ILjava/util/HashMap;)V
    ...
    :goto_1
    iget-object v1, p0, Lcn/sharesdk/framework/d;->a:Lcn/sharesdk/framework/PlatformActionListener;
    ...
    invoke-interface {v1, p1, p2, p3}, Lcn/sharesdk/framework/PlatformActionListener;->onComplete(Lcn/sharesdk/framework/Platform;ILjava/util/HashMap;)V
    :try_end_1
    ...
    iput-object v1, v3, Lcn/sharesdk/framework/statistics/b/f;->o:[Ljava/lang/String;
    ...
    :goto_3
    iput-object v1, v3, Lcn/sharesdk/framework/statistics/b/f;->b:Ljava/lang/String;

    invoke-virtual {p1}, Lcn/sharesdk/framework/Platform;->getPlatformId()I

    move-result v1

    iput v1, v3, Lcn/sharesdk/framework/statistics/b/f;->a:I

    invoke-virtual {p1, v2, v0}, Lcn/sharesdk/framework/Platform;->filterShareContent(Lcn/sharesdk/framework/Platform$ShareParams;Ljava/util/HashMap;)Lcn/sharesdk/framework/statistics/b/f$a;
