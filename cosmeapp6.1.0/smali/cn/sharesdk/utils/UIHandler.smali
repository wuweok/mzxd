.class public Lcn/sharesdk/utils/UIHandler;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcn/sharesdk/utils/UIHandler;->prays:[Ljava/lang/String;
...
.method static synthetic access$0(Landroid/os/Message;)V
    ...
    invoke-static {p0}, Lcn/sharesdk/utils/UIHandler;->handleMessage(Landroid/os/Message;)V
...
.method private static getShellMessage(ILandroid/os/Handler$Callback;)Landroid/os/Message;
    ...
    invoke-static {v0, p1}, Lcn/sharesdk/utils/UIHandler;->getShellMessage(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static prepare()V
    ...
    sget-object v0, Lcn/sharesdk/utils/UIHandler;->handler:Landroid/os/Handler;

    if-nez v0, :cond_0

    new-instance v0, Landroid/os/Handler;

    new-instance v1, Lcn/sharesdk/utils/UIHandler$1;

    invoke-direct {v1}, Lcn/sharesdk/utils/UIHandler$1;-><init>()V

    invoke-direct {v0, v1}, Landroid/os/Handler;-><init>(Landroid/os/Handler$Callback;)V

    sput-object v0, Lcn/sharesdk/utils/UIHandler;->handler:Landroid/os/Handler;

    invoke-static {}, Lcn/sharesdk/utils/UIHandler;->printPray()V
...
.method private static printPray()V
    ...
    sget-object v1, Lcn/sharesdk/utils/UIHandler;->prays:[Ljava/lang/String;
    ...
    const-string v1, "UIHandler printPray == "
    ...
    invoke-static {v1, v0}, Lcn/sharesdk/utils/Ln;->d(Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
...
.method public static sendEmptyMessage(ILandroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p1}, Lcn/sharesdk/utils/UIHandler;->getShellMessage(ILandroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static sendEmptyMessageAtTime(IJLandroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p3}, Lcn/sharesdk/utils/UIHandler;->getShellMessage(ILandroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static sendMessage(Landroid/os/Message;Landroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p1}, Lcn/sharesdk/utils/UIHandler;->getShellMessage(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
...
.method public static sendMessageAtTime(Landroid/os/Message;JLandroid/os/Handler$Callback;)Z
    ...
    invoke-static {p0, p3}, Lcn/sharesdk/utils/UIHandler;->getShellMessage(Landroid/os/Message;Landroid/os/Handler$Callback;)Landroid/os/Message;
